...
layout_H2=QHBoxLayout() #панель вопроса и результата.
...
#current_question = -1
total = 0 #количество заданных вопросов
score = 0 #количество очков за правильные ответы
...
questions_list.append(Question('Когда первый человек вышел в открытый космос?', 'В 1965 году', 'В 1957 году', 'В 1979 году', 'В 1997 году'))
questions_list.append(Question('В каком году закончилась Северная война?', '1721', '1809', '1940', '1699'))
